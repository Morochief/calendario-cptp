    ...
    return (
        <>
            ...
            <div className="print:hidden">
                <Header />
                <main className="admin-container" id="main-content" style={{ maxWidth: '1200px', margin: '0 auto', padding: '1.5rem 1rem' }}>
                    <Breadcrumbs />
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: '0.25rem 0 0 0' }}>
                                Carga de datos para generar e imprimir el documento oficial de exención del CPTP.
                            </p>
                        </div>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <form onSubmit={(e) => { e.preventDefault(); handlePrint(); }} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
